                    ...
                    <div class="cardContainer" v-for="(item, index) in listData" :item="item">
                        <van-cell style="background: none;">
                            <van-row>
                                <!--危险点名称-->
                                <van-col span="18">
                                    <span class="cellLabel">{{item.signType=='sign_type_1'? $t('safe_drawing_point.name'):$t('danger_project.name')}}:</span>
                                    <span>{{item.name}}</span>
                                </van-col>
                                <!--危险点状态-->
                                <van-col span="6">
                            ...
                            <van-row>
                                <!--危险点分类-->
                                <span class="cellLabel">{{listData.signType=='sign_type_1'? $t('safe_drawing_point.drawingPointType'):$t('danger_project.drawingPointType')}} :</span>
                                <span>{{$translate({key: 'drawing_point_type',value:item.drawingPointType})}}
                                        </span>
                            </van-row>
                            <van-row>
                                <!--危险点编号-->
                                <span class="cellLabel">{{item.signType=='sign_type_1'? $t('safe_drawing_point.pointCode'):$t('danger_project.pointCode')}} :</span>
                                <span>{{item.code}}</span>
                            </van-row>
