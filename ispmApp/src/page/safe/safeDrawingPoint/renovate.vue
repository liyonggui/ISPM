<template>
<tms-page>
    <nav-bar slot="header" left-arrow :left-text="$t('public.back')" @click-left="toBack" :title="formModel.signType=='sign_type_1'?$t('safe_drawing_point.renovate'):$t('danger_project.renovate')">
    </nav-bar>
    ...
    methods: {
        ...
        getData() {
            ...
            this.$axios.post(uri.get, {
                ...
                .then(resp => {
                    this.formModel = Object.assign({}, this.formModel, resp.drawing)
                    this.formModel.issuePosition = resp.name
                    this.formModel.signType = resp.signType
                    this.formModel.type = 'rectify_type_1'
                    this.formModel.code = resp.code
                    this.formModel.drawingPointId = resp.id
