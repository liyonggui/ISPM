...
public extension UIColor {
    @objc public static let mainBackgroundBlue = UIColor(red: 24/255, green: 44/255, blue: 70/255, alpha: 1)
    ...
    @objc public static let mainTextBlue = UIColor(red: 12/255, green: 187/255, blue: 255/255, alpha: 1)
}
...
public extension UIColor {
    ...
    @objc public static var black = UIColor(white: 35/255, alpha: 1)
